# Generated by Django 5.0 on 2023-12-24 16:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_fsm.FSMField(choices=[('M', 'Ожидает модерацию'), ('P', 'Опубликовано'), ('D', 'На удалении')], default=('M', 'Ожидает модерацию'), max_length=50, verbose_name='Статус')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Время создания')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Время изменения')),
                ('description', models.TextField(blank=True, verbose_name='Описание')),
                ('current_photo', models.ImageField(blank=True, default=None, null=True, upload_to='photos/%Y/%m/%d', verbose_name='Фотография')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', related_query_name='comment', to='models_app.photo')),
            ],
            options={
